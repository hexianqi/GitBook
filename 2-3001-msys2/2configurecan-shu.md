...
--disable-simple\_idct    disable simple IDCT routines \[default=no\]            禁用simple IDCT例程 \[关闭\]
...
--disable-strip          disable stripping of executables and shared libraries禁用剥离可执行程序和共享库
